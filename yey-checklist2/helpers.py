...
def checkPermission(user=None, cl=None, item=None, edit=True):
  '''
  @summary: 
...
def checkPermissionAndRespond(request, user=None, cl=None, item=None, edit=True):
  '''
  @summary: Check permission. If permission is denied, respond with a default message.
  '''
  if not checkPermission(user, cl, item, edit):
